var data=[
  ...
  function pageButtons(pages){
      ...
      pag_button_first.style.color='red';
      ...
      pag_button_last.style.color='red';
  ...
  function createTable(arr){
      ...
      var thead = createElemet('thead','bg-success');
      thead.style.color="block";
